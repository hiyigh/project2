...
public enum ErrorCode {
    ...
    NAME_DUPLICATED("name", "name.duplicated", "닉네임이 중복됩니다.", HttpStatus.BAD_REQUEST),
    NAME_EQUAL_PREVIOUS("name", "name.equal.previous", "닉네임이 이전과 같습니다.", HttpStatus.BAD_REQUEST),
    ...
    NAME_NOT_EQUAL("name", "name.notequal", "닉네임이 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
